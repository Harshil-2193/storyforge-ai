...
from schemas.story import CompleteStoryNodeRespose, CompleteStoryResponse, CreateStoryRequest
...
def get_session_id(session_id:Optional[str]=Cookie(default=None)):
    if not session_id:
